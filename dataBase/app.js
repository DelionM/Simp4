(function() {
  ...
  select1.addEventListener("change", function () {
    ...
    if (selectedOption.value) {
      ...
      AddToDatabase("selectedOption.value");zz
    } else {
  ...
  select2.addEventListener("change", function () {
    ...
    if (selectedOption.value) {
      ...
      console.log(vestimentaDelPersonaje);
      AddToDatabase(vestimentaDelPersonaje);
    } else {
  ...
  //Tenemos que crear un nuevo documento de tareas e introducirlo en la base de datos
  // function addTodo(personajeElejido, numeroDisfraz) {
  //   var todo = {
  //     _id: new Date().toISOString(),
  //     personaje: personajeElejido,
  //     disfraz: numeroDisfraz
  //   };
  ...
  function AddToDatabase(nombrepersonajeP){
    var todo = {
      Nombre: nombrepersonajeP
    };
