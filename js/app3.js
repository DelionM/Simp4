...
select2.addEventListener("change", function () {
  ...
  if (personajeSeleccionado === "hola") {
    switch (valorSeleccionado) {
      case "Vestimenta 1":
        posterPersonaje.src = "../assets/transformacion/apu1.webp";
        break;
      case "Vestimenta 2":
        posterPersonaje.src = "../assets/transformacion/apu2.png";
        break;
    }
    ...
    switch (valorSeleccionado) {
      case "Disfraz 1":
        posterPersonaje.src = "../assets/transformacion/homer1.png";
        break;
      case "Disfraz 2":
        posterPersonaje.src = "../assets/transformacion/homer2.webp";
        break;
    ...
    switch (valorSeleccionado) {
      case "Disfraz 1":
        posterPersonaje.src = "../assets/transformacion/bar1.jpg";
        break;
      case "Disfraz 2":
        posterPersonaje.src = "../assets/transformacion/bar2.webp";
        break;
    }
  } else if (personajeSeleccionado === "Bard") {
    switch (valorSeleccionado) {
      case "Vestimenta 1":
        posterPersonaje.src = "../assets/transformacion/bard1.png";
        break;
      case "Vestimenta 2":
        posterPersonaje.src = "../assets/transformacion/bard2.png";
        break;
    }
  } else if (personajeSeleccionado === "Liza") {
    switch (valorSeleccionado) {
      case "Disfraz 1":
        posterPersonaje.src = "../assets/transformacion/liza1.png";
        break;
      case "Disfraz 2":
        posterPersonaje.src = "../assets/transformacion/liza2.webp";
        break;
    }
  } else if (personajeSeleccionado === "March") {
    switch (valorSeleccionado) {
      case "Vestimenta 1":
        posterPersonaje.src = "../assets/transformacion/marge1.png";
        break;
      case "Vestimenta 2":
        posterPersonaje.src = "../assets/transformacion/marge2.png";
        break;
    }
  } else if (personajeSeleccionado === "Magie") {
    switch (valorSeleccionado) {
      case "Disfraz 1":
        posterPersonaje.src = "../assets/transformacion/magi1.jpg";
        break;
      case "Disfraz 2":
        posterPersonaje.src = "../assets/transformacion/magi2.webp";
        break;
    }
  } else if (personajeSeleccionado === "Flanders") {
    switch (valorSeleccionado) {
      case "Vestimenta 1":
        posterPersonaje.src = "../assets/transformacion/flander1.png";
        break;
      case "Vestimenta 2":
        posterPersonaje.src = "../assets/transformacion/flander2.png";
        break;
      case "Vestimenta 3":
        posterPersonaje.src = "../assets/transformacion/flander3.webp";
        break;
    }
  } else if (personajeSeleccionado === "Barney") {
    switch (valorSeleccionado) {
    ...
    switch (valorSeleccionado) {
      case "Vestimenta 1":
        posterPersonaje.src = "../assets/transformacion/moe1.webp";
        break;
      case "Vestimenta 2":
        posterPersonaje.src = "../assets/transformacion/moe2.png";
        break;
    }
  } else if (personajeSeleccionado === "MontgomeryBurns") {
    switch (valorSeleccionado) {
      case "Disfraz 1":
        posterPersonaje.src = "../assets/transformacion/burn1.webp";
        break;
      case "Disfraz 2":
        posterPersonaje.src = "../assets/transformacion/burn2.jpg";
        break;
    }
  }
});
